...
public class TokenAPI {
    ...
    // TODO POST @ http://localhost:8081/account/token with auth running as Gradle and cust running on docker - returns fake key
	private Customer getCustomerByNameFromCustomerAPI(String username) {
		try {
			//CHANGED TODO
			URL url = new URL("http://localhost:8080/Customer/name/" + username);
